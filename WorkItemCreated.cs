...
namespace ADOSync
{
    public static class WorkItemCreated
    {
            ...
            ILogger log)
        {
            ...
            log.LogInformation($"++++++++++WorkItemCreate was triggered!");
            ...
            log.LogInformation(workItemType);
            log.LogInformation(title);
            log.LogInformation(workItemID);
            log.LogInformation(sourceTeamProject);
            ...
            log.LogInformation("PAT . " + destPAT);
            ...
            if (workItemType == "Test Plan")
            {
                ...
                log.LogInformation("Created testplan: " + testplan);
                return req.CreateResponse<string>(HttpStatusCode.OK,"");
            }
            else if (workItemType == "Test Suite")
            {
                ...
                // other test suites inside a test plan should be created and associated normally
                {
                    ...
                    log.LogInformation("Created test suite: " + testsuiteid);
                    return req.CreateResponse(HttpStatusCode.OK, "");
                }
                else
                {
                    log.LogInformation("Test Suite Not Created");
            ...
            else
            {
                ...
                foreach (JProperty property in ((JObject)originalWI["resource"]["fields"]).Properties())
                {
                    ...
                    else if (property.Name == "Microsoft.VSTS.TCM.TestSuiteAudit")
                    {
                        ...
                        log.LogInformation(value + " - " + numbers.Length.ToString());
                ...
                {
                    log.LogInformation(originalWI["resource"]["relations"].GetType().ToString());
        ...
        private static async Task CreateWorkItem(string VSTS, string PAT, string TeamProject, string WorkItemType, JsonPatch jsonPatch, ILogger log)
        {
