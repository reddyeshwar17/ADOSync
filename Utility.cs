...
namespace ADOSync
{
    public class Utility
    {
        ...
        public static async Task<string> GetDestinationWorkItemId(string VSTS, string PAT, string TeamProject, string originalWorkItemId, ILogger log)
        {
        ...
        public static async Task<string> GetSourceWorkItemId(string VSTS, string PAT, string TeamProject, string WorkItemId, ILogger log)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                           ...
                           getUri))
                {
                    ...
                    if (responseBody.IndexOf("OriginalID=") > 0)
                    {
                        ...
                        log.LogInformation(returnValue);
                        return returnValue;
                    }
                    else
                    {
        ...
        public static async Task<string> CreateTestPlan(string VSTS, string PAT, string TeamProject, string WorkItemId, string title, string areapath, string iteration, ILogger log)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                log.LogInformation(postContent);
        ...
        public static async Task<string> UpdateTestCase(string VSTS, string PAT, string TeamProject, string originalTestCase, ILogger log)
        {
        ...
        public static async Task<string> GetTestCaseById(string VSTS, string PAT, string TeamProject, string TestSuiteId, string TestCaseId, ILogger log)
        {
            ...
            log.LogInformation("Test Plan Id: " + testPlanId);
        ...
        public static async Task<bool> AddTestCaseToTestSuite(string VSTS, string PAT, string TeamProject, string TestSuiteId, string TestCaseId, string TestCase, ILogger log)
        {
        ...
        public static async Task<bool> DeleteTestSuite(string VSTS, string PAT, string TeamProject, string TestSuiteId, ILogger log)
        {
        ...
        public static async Task<bool> RemoveTestCaseFromTestSuite(string VSTS, string PAT, string TeamProject, string TestSuiteId, string TestCaseId, ILogger log)
        {
        ...
        public static async Task<string> CreateTestSuite(string VSTS, string PAT, string TeamProject, string TestPlan, string ParentTestSuite, string OriginalID, string json, ILogger log)
        {
        ...
        public static async Task<bool> UpdateWorkItemOriginalIDTag(string VSTS, string PAT, string TeamProject, string WorkItemId, string OriginalId, ILogger log)
        {
            ...
            if (workitem.Contains("System.Tags"))
            {
                ...
                {
                    log.LogInformation("Tags already contains OriginalID");
                }
                else
                {
        ...
        public static async Task UpdateWorkItem(string VSTS, string PAT, string TeamProject, string WorkItemId, JsonPatch jsonPatch, ILogger log)
        {
        ...
        public static async Task<string> GetDestinationWorkItem(string VSTS, string PAT, string TeamProject, string WorkItemId, ILogger log)
        {
        ...
        public static async Task<byte[]> GetSourceAttachment(string Url, string PAT, ILogger log)
        {
        ...
        public static async Task<string> CreateAttachment(string VSTS, string PAT, string FileName, byte[] FileContent, ILogger log)
        {
        ...
        public static async Task<string> GetLinkedUrl(string VSTS, string PAT, string TeamProject, JObject relation, ILogger log)
        {
        ...
        public static async Task<string> GetRelationNumber(string VSTS, string PAT, string TeamProject, JObject relation, ILogger log)
        {
            string url = relation.Properties().FirstOrDefault(x => x.Name == "url").Value.ToString();
        ...
        public static async Task<string> GetTestSuitesFromTestPlan(string VSTS, string TeamProject, string PAT, string TestPlanId, ILogger log)
        {
        ...
        public static async Task<string> GetTestPlanFromRootTestSuite(string VSTS, string TeamProject, string PAT, string TestSuiteId, ILogger log)
        {
                    ...
                    try
                    {
                        ...
                        foreach (JObject value in values.Children())
                        {
                            ...
                            if (rootSuiteId == TestSuiteId)
                            {
                                ...
                                log.LogInformation("Found Plan: " + planId);
                                return planId;
                            }
                        }
                    }
        ...
        public static async Task<string> GetTestPlanFromGenericTestSuite(string VSTS, string TeamProject, string PAT, string TestSuiteId, ILogger log)
        {
            //https://docs.microsoft.com/en-us/rest/api/vsts/test/test%20%20plans/list?view=vsts-rest-5.0
        ...
        public static async Task<string> GetRequirementId(string VSTS, string TeamProject, string PAT, string TestPlanId, string TestSuiteId, ILogger log)
        {
        ...
        public static async Task<string> PostJsonString(string PAT, string url, string json, ILogger log)
        {
            using (HttpClient client = new HttpClient())
            {
                Utility.SetAuthentication(client, PAT);
        ...
        public static async Task<string> PatchJsonString(string PAT, string url, string json, ILogger log)
        {
            using (HttpClient client = new HttpClient())
            {
                Utility.SetAuthentication(client, PAT);
        ...
        public static async Task<string> GetJsonFromUrl(string PAT, string url, ILogger log)
        {
            using (HttpClient client = new HttpClient())
            {
                Utility.SetAuthentication(client, PAT);
